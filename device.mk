...
PRODUCT_PROPERTY_OVERRIDES += \
    ...
    ro.rommanager.developerid=icecoldsandwich \
...
PRODUCT_COPY_FILES += \
    ...
    device/htc/glacier/firmware/hdcp.keys:system/vendor/firmware/hdcp.keys \
    ...
    device/htc/glacier/firmware/default_org_wb.acdb:system/etc/firmware/default_org_wb.acdb
...
PRODUCT_COPY_FILES += \
    ...
    device/htc/glacier/proprietary/TPA2051_CFG_XC.csv:system/etc/TPA2051_CFG_XC.csv
...
PRODUCT_COPY_FILES += \
    device/htc/glacier/proprietary/hwcomposer.msm7x30.so:system/lib/hw
...
PRODUCT_COPY_FILES += \
    ...
    device/htc/glacier/proprietary/libcamera.so:obj/lib/libcamera.so
...
PRODUCT_COPY_FILES += \
    ...
    device/htc/glacier/proprietary/libGLES_android.so:/system/lib/egl/libGLES_android.so \
